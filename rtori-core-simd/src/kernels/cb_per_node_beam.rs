    ...
    simba::simd::Simd<core::simd::Simd<f32, L>>: nalgebra::SimdRealField,
{
    ...
    .map(move |(beam_spec, beam_length, beam_k, beam_d)| {
        ...
        // /* 2025-01-13 */ println!("per_node_beam: neighbour offset: {neighbour_position_offset:?}, node offset: {node_position_offset:?}");
        ...
        let (delta_p, error) = {
            ...
            // /* 2025-01-13 */ println!("per_node_beam: nominal_distance: {nominal_distance:?}, offset_distance: {offset_distance:?}, delta_p: {delta_p_uncorrected:?}");
            ...
            //println!("per_node_beam: delta_p pre-correction: {delta_p_uncorrected:?}, beam_length {beam_length:?}, delta_p_length {delta_p_length:?}");
