...
macro_rules! define_mappable_pair{
    ($associated_type:ident, $inner_type:ty, $fn_name:ident) => {
        ...
        fn $fn_name<'call>(&'call mut self) -> Self::$associated_type<'call> where 'call: 'container  {
...
impl<'container> rtori_os_model::MappedDestination<'container> for Loader<'container> {
    ...
    define_mappable_pair!(NodeExternalForcesMap, rtori_os_model::Vector3F, map_node_external_forces);
    define_mappable_pair!(NodeConfigMap, rtori_os_model::NodeConfig, map_node_config);
    define_mappable_pair!(NodeGeometryMap, rtori_os_model::NodeGeometry, map_node_geometry);
    define_mappable_pair!(CreaseGeometryMap, rtori_os_model::CreaseGeometry, map_crease_geometry);
    define_mappable_pair!(CreaseParametersMap, rtori_os_model::CreaseParameters, map_crease_parameters);
    define_mappable_pair!(FaceIndicesMap, rtori_os_model::Vector3U, map_face_indices);
    define_mappable_pair!(FaceNominalAnglesMap, rtori_os_model::Vector3F, map_face_nominal_angles);
    define_mappable_pair!(NodeCreaseMap, rtori_os_model::NodeCreaseSpec, map_node_crease);
