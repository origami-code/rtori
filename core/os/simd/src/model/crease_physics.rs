...
use simd_common::{impl_aosoa_flat, SimdF32};
    ...
    LaneCount<L>: SupportedLaneCount,
{
    ...
    #[inline]
    pub fn simd_is_invalid(&self) -> simd_common::SimdMask<L> {
    ...
    LaneCount<L>: SupportedLaneCount,
{
    ...
    impl_aosoa_flat!(f32, L, 4, [a_height, a_coef, b_height, b_coef]);
}
...
mod test {
    ...
    use simd_common::{SimdF32, SimdU32};
