    ...
    inputs.node_face_spec.iter().map(
        ...
        move |spec| {
            ...
            let face_vertex_indices =
                simd_common::gather::gather_vec3(inputs.face_node_indices, spec.face_indices);
            ...
            let angles_diff =
                to_nalgebra3(nominal_angles) - nalgebra::Vector3::new(angles[0], angles[1], angles[2]);
            ...
            let normal = to_nalgebra3(normal);
