...
impl PassPerCreaseFoldAngle {
    pub fn new(
        ...
        let bgl_specific = device.create_bind_group_layout(&super::bgld::per_crease_fold_angles::BIND_GROUP_PER_CREASE_FOLD_ANGLES);

        let shader_module = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("rtori-cs-per-crease-fold_angle"),
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("../../../shaders/1-PerCrease-FoldAngles.wgsl")))
        });
