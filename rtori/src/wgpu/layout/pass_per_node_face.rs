...
impl PassPerNodeFace {
    pub fn new(
        ...
        let bgl_specific = device.create_bind_group_layout(&super::bgld::per_node_face::BIND_GROUP_PER_NODE_FACE);

        let shader_module =  device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("rtori-cs-per-node-face"),
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("../../../shaders/2c0-PerNodeFace.wgsl")))
        });
