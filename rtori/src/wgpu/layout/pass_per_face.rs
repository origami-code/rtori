...
impl PassPerFace {
    pub fn new(device: &wgpu::Device, common_bind_group_layout: &wgpu::BindGroupLayout) -> Self {
        let bgl_specific = device.create_bind_group_layout(&super::bgld::per_face::BIND_GROUP_PER_FACE);
        ...
        let shader_module = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("../../../shaders/0-PerFace-CalculateNormal.wgsl")))
        });
